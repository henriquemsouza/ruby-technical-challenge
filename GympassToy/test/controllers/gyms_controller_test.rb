...
class GymsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gym" do
    assert_difference('Gym.count') do
      post gyms_url, params: { gym: { address: @gym.address, close_time: @gym.close_time, gym_manager: @gym.gym_manager, gym_name: @gym.gym_name, open_time: @gym.open_time } }
    end
  ...
  test "should update gym" do
    patch gym_url(@gym), params: { gym: { address: @gym.address, close_time: @gym.close_time, gym_manager: @gym.gym_manager, gym_name: @gym.gym_name, open_time: @gym.open_time } }
